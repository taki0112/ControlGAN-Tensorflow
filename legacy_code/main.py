from ControlGAN import ControlGAN
import argparse
from utils import *

"""parsing and configuration"""
def parse_args():
    desc = "Tensorflow implementation of ControlGAN"
    ...
    parser.add_argument('--vgg_weight', type=int, default=1, help='Weight about vgg perceptual loss')
    parser.add_argument('--word_weight', type=int, default=1, help='Weight about word loss')
